 ...
 */
package org.verizon.nifi.pulsar.producer;
...
import org.verizon.nifi.pulsar.service.PulsarClientLRUCache;
import org.verizon.nifi.pulsar.service.PulsarClientService;
...
public abstract class AbstractPulsarProducerProcessor<T> extends AbstractProcessor {
    ...
    private synchronized List<AsyncPublisher> getAsyncPublishers() {
        return asyncPublishers;
    }

    private synchronized void setAsyncPublishers(List<AsyncPublisher> list) {

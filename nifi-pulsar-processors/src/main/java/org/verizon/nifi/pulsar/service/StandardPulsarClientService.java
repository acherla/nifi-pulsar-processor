...
import org.verizon.nifi.pulsar.PulsarPropertiesUtils;
...
public class StandardPulsarClientService extends AbstractControllerService implements PulsarClientService {
    ...
    static {
        ...
        props.add(PulsarPropertiesUtils.tlsAllowInsecureConnection);
        props.add(PulsarPropertiesUtils.tlsHostnameVerificationEnable);
    ...
    private ClientBuilder getClientBuilder(ConfigurationContext context) throws UnsupportedAuthenticationException, MalformedURLException {
        ...
        ClientBuilder builder = PulsarClient.builder()
                ...
                .allowTlsInsecureConnection(context.getProperty(PulsarPropertiesUtils.tlsAllowInsecureConnection).asBoolean())
                .enableTlsHostnameVerification(context.getProperty(PulsarPropertiesUtils.tlsHostnameVerificationEnable).asBoolean());
